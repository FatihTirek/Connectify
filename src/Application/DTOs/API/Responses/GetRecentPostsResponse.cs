...
{
    public record GetRecentPostsResponse
    {
        public record Success : GetRecentPostsResponse
        {
        ...
        public record Failure(IEnumerable<ValidationError> Errors) : GetRecentPostsResponse;
    }
}