    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendships", x => new { x.FollowerId, x.FolloweeId });
                    table.ForeignKey(
            ...
            var path = $"{Directory.GetCurrentDirectory()}/src/Infrastructure/Persistence/SQL/TriggersUp.sql";
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var path = $"{Directory.GetCurrentDirectory()}/src/Infrastructure/Persistence/SQL/TriggersDown.sql";
            migrationBuilder.Sql(File.ReadAllText(path));
        }
    }
}
